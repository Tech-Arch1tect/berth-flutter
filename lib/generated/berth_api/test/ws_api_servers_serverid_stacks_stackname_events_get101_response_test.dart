...
// tests for WsApiServersServeridStacksStacknameEventsGet101Response
void main() {
  // final instance = WsApiServersServeridStacksStacknameEventsGet101Response();

  group('test WsApiServersServeridStacksStacknameEventsGet101Response', () {
    // String containerId
    ...
    // List<Port> ports (default value: const [])
    ...
    // int stopped
    test('to test the property `stopped`', () async {
      // TODO
    });
