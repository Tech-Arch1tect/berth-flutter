...
// tests for OperationLogResponse
void main() {
  // final instance = OperationLogResponse();

  group('test OperationLogResponse', () {
    // String command
    ...
    test('to test the property `formattedDate`', () async {
      // TODO
    });
    ...
    // bool isIncomplete
    test('to test the property `isIncomplete`', () async {
      // TODO
    });
    ...
    test('to test the property `partialDurationMs`', () async {
      // TODO
    });
    ...
    test('to test the property `triggerSource`', () async {
      // TODO
    });
