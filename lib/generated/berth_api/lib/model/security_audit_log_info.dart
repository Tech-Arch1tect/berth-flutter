...
class SecurityAuditLogInfo {
  /// Returns a new [SecurityAuditLogInfo] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SecurityAuditLogInfo &&
  ...
  /// Returns a new [SecurityAuditLogInfo] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SecurityAuditLogInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SecurityAuditLogInfo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SecurityAuditLogInfo[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SecurityAuditLogInfo> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SecurityAuditLogInfo>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SecurityAuditLogInfo.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SecurityAuditLogInfo> mapFromJson(dynamic json) {
    final map = <String, SecurityAuditLogInfo>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SecurityAuditLogInfo.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SecurityAuditLogInfo-objects as value to a dart map
  static Map<String, List<SecurityAuditLogInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SecurityAuditLogInfo>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SecurityAuditLogInfo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
