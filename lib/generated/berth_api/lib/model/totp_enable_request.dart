    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TOTPEnableRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TOTPEnableRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
