...
class TOTPSetupResponse {
  ...
  @override
  String toString() => 'TOTPSetupResponse[data=$data, success=$success]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TOTPSetupResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TOTPSetupResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
